...
>[!example] ## Techniques to address challenges in imitation learning
...
- ## Observation space
	...
	- **the target reference pose** (absolute and relative, 63 values) at time t + 1. (*We have this from the dataset $\implies$ Big advantage of imitation learning*) 
